            ...
            switch ($mode) {
                ...
                default:
                    ...
                    echo "<table>";
                        ...
                        echo '<th onclick="sortTable(0)"><a class="sort">Leerlingen</a></th>';
                        echo '<th onclick="sortTable(1)">Cijfers</th>';
                        echo '<th onclick="sortTable(2)">Vakken</th>';
                        echo '<th onclick="sortTable(3)">Docenten</th>';
                        echo '<th>Verwijderen</th>';
